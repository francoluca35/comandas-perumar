...
export default function Pedidos() {
  ...
  useEffect(() => {
    ...
    const precioBase = seleccionado.precio || 0;
    const adicionalesPrecio = adicionalesSeleccionados.length * 200; // cada adicional vale 200
    setTotal(precioBase + adicionalesPrecio);
  }, [comida, adicionalesSeleccionados, productos]);
