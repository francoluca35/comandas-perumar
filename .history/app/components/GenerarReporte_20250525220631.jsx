...
export default function GenerarReporte() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-800 via-purple-800 to-pink-700 text-white px-4">
        ...
        <button
          ...
          className={`w-full flex justify-center items-center gap-3 px-6 py-3 rounded-2xl text-lg font-semibold transition-transform duration-200 ${
            loading
              ...
              : "bg-gradient-to-r from-green-400 to-blue-500 hover:scale-105 active:scale-95"
          }`}
        >
          {loading && (
            <svg
