  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      {botones.map((btn, i) => (
        <div
          key={i}
          className="bg-white text-black rounded-lg p-6 w-40 h-28 flex flex-col items-center justify-center shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer"
