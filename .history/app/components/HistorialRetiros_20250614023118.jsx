  ...
  const fetchInforme = async () => {
    try {
      ...
      const ordenado = data.sort((a, b) => {
        if (!a.fecha || !b.fecha) return 0; // si alguno no tiene fecha, no romper
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-black to-blue-950">
      ...
      <div className="flex flex-col items-center justify-center mt-10 px-4">
        ...
        <div className="bg-black/50 p-6 rounded-xl w-full max-w-5xl">
          <h3 className="text-white text-2xl text-center mb-6">
            Historial de Retiros
          </h3>
          <table className="w-full text-center text-white text-sm">
            <thead>
