...
export default function RestauranteForm() {
  ...
  useEffect(() => {
    if (modoComision === "sumar") {
      ...
      setTotalMP(Number(comisionMP) || Number(total));
    }
  }, [total, comisionMP, modoComision]);
          ...
          <div className="mb-4 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <input
                ...
                placeholder={modoComision === "sumar" ? "0.00" : total.toFixed(2)}
              />
            ...
            <div className="text-center mt-1 mb-2">
              ...
              {modoComision === "sumar" && comisionMP > 0 && (
                <div className="text-xs text-gray-600">
                  (${total.toFixed(2)} + ${comisionMP.toFixed(2)} comisión)
                </div>
              )}
              {modoComision === "reemplazar" && comisionMP > 0 && (
                <div className="text-xs text-gray-600">
                  (reemplaza ${total.toFixed(2)})
                </div>
              )}
            </div>
          </div>
