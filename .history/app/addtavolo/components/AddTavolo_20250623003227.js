    ...
    <section className="min-h-screen p-6 bg-gradient-to-br from-red-600 via-black to-blue-950 text-white">
      <div className="max-w-xl mx-auto border border-white/20 rounded-2xl p-6 bg-white/5 backdrop-blur-xl">
        ...
        <div className="space-y-4">
          ...
          >
            <option className="bg-white/10 text-black" value="">
              -- Tipo de mesa a agregar --
            </option>
            <option className="bg-white/10 text-black" value="mesaAdentro">
              🍽 Adentro A
            </option>
            <option className="bg-white/10 text-black" value="mesaAdentro2">
              🍽 Adentro B
            </option>
            <option className="bg-white/10 text-black" value="mesaAfuera">
              🌤 Afuera
            </option>
          </select>
