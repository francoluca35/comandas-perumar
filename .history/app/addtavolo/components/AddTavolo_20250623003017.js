      ...
      <div className="max-w-xl mx-auto border border-white/20 rounded-2xl p-6 bg-white/5 backdrop-blur-xl">
        ...
        <div className="space-y-4">
          <select
            ...
            className="w-full bg-transparent text-white px-4 py-2 rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option className="b text-white" value="">
              -- Tipo de mesa a agregar --
            </option>
            <option className="bg-black text-white" value="mesaAdentro">
              🍽 Adentro A
            </option>
            <option className="bg-black text-white" value="mesaAdentro2">
              🍽 Adentro B
            </option>
            <option className="bg-black text-white" value="mesaAfuera">
              🌤 Afuera
            </option>
          </select>
          ...
          {mostrarEliminar && (
            <div className="space-y-4 mt-4">
              ...
              <select
                ...
                className="w-full bg-white/10 px-4 py-2 rounded-xl"
              >
                <option value="">-- Tipo de mesa a eliminar --</option>
                <option value="mesaAdentro">🍽 Adentro A</option>
                <option value="mesaAdentro2">🍽 Adentro B</option>
                <option value="mesaAfuera">🌤 Afuera</option>
              </select>
              <input
                type="number"
                min={1}
