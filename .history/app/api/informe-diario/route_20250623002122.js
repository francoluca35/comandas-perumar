  ...
  try {
    ...
    for (const retiro of retiros) {
      try {
        ...
        const motivo = retiro.motivo || "";
        const montoActual = retiro.montoActualizado ?? null;

        agruparPorFecha[fecha].retirosTotal += monto;
        ...
        console.warn("Retiro con timestamp inválido:", retiro);
        continue;
      }
    }
