...
export async function GET() {
  try {
    ...
    const ingresos = await db.collection("ingresosDiarios").insertOne({
      ingresoTotal: totalPedido, // 👈 así lo vas a leer después
      fecha: new Date(timestamp), // 👈 clave: usá "fecha"
    });
